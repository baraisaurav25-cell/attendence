...
def admin_panel():
    ...
    selected = st.multiselect("Assign Sections", sections)
...
def dashboard():
    ...
    st.subheader("➕ Create Section (User Allowed)")
    ...
    if not sections:
        st.warning("No assigned sections yet")
        return
...
def attendance_page():
    ...
    st.subheader("Click ID to mark attendance")
