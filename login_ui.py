...
login_ui.py
-----------
Login and registration page for Smart Attendance.
"""
...
""", unsafe_allow_html=True)
    ...
    with mid:
        st.markdown(
            "<h3 style='text-align:center;margin-bottom:12px'>Welcome Back 👋</h3>",
            unsafe_allow_html=True,
        )
    ...
    # ── Footer ────────────────────────────────────────────────────────────────
    st.markdown(
        "<div class='foot'>Built with ❤️ for <b>BGE · SAU</b> · Powered by Streamlit</div>",
        unsafe_allow_html=True,
               )
